...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(GPIOC, AMB2_Pin|AMB1_Pin);

    HAL_GPIO_DeInit(BREF_GPIO_Port, BREF_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN6
    */
    HAL_GPIO_DeInit(GPIOA, RM1_Pin|RM2_Pin|RM3_Pin|RM6_Pin
                          |RM5_Pin|RM4_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC3_IN0
    */
    HAL_GPIO_DeInit(GPIOC, AIN4_Pin|AIN2_Pin|AIN1_Pin);

    HAL_GPIO_DeInit(AIN3_GPIO_Port, AIN3_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, GSCK_Pin|GMISO_Pin|GMOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, TX1_Pin|RX1_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, TX2_Pin|RX2_Pin);
