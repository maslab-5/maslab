 ...
 * TIM12 - M6
 *
 * TIM5 - Shift Register Frames
 * TIM7 - Digital Read Frames
 *
 * I2C1 - External
 * I2C2 - OLED
 *
 * SPI3 - Gyroscope/Accelerometer + Temperature
 *
 * UART2 - External 1
 * UART6 - External 2
 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, TRIG2_Pin|LMSV_Pin|LMCLK_Pin|ENPL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TRIG1_Pin|LMDAT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ENCLK_GPIO_Port, ENCLK_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GCS_GPIO_Port, GCS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : LMDAT_Pin */
  GPIO_InitStruct.Pin = LMDAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LMDAT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : LMSV_Pin LMCLK_Pin ENPL_Pin ENCLK_Pin */
  GPIO_InitStruct.Pin = LMSV_Pin|LMCLK_Pin|ENPL_Pin|ENCLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DRE1_Pin RMD7_Pin RMD8_Pin RMD9_Pin
                           RMD10_Pin */
  GPIO_InitStruct.Pin = DRE1_Pin|RMD7_Pin|RMD8_Pin|RMD9_Pin
                          |RMD10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
	if (htim == &htim5) {
		registerHandler();
	} else { //Timer 7 for digital read of UI
